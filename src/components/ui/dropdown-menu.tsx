...
const DropdownMenuLabel: Component<ComponentProps<'div'> & { inset?: boolean }> = (props) => {
	...
	return <div class={cn('px-2 py-1.5 font-semibold text-sm', props.inset && 'pl-8', props.class)} {...rest} />;
};
...
const DropdownMenuGroupLabel = <T extends ValidComponent = 'span'>(
	...
	return <DropdownMenuPrimitive.GroupLabel class={cn('px-2 py-1.5 font-semibold text-sm', props.class)} {...rest} />;
};
